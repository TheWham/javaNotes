...
- [十四、需要重点修正的原笔记表达](#十四需要重点修正的原笔记表达)
- [十五、复习路线建议](#十五复习路线建议)
- [十六、最后冲刺：万能回答结构](#十六最后冲刺万能回答结构)
- [十七、结合简历的面试官追问与回答模板](#十七结合简历的面试官追问与回答模板)
...
**回答:** 不能. 它只能保证最终一致性. 读操作读的是旧数据, 写操作在新数组上改, 改完才把引用切过去.在切换引用之前, 读线程看到的都是老数据
