...
1. [发送者可靠性](RabbitMQ高级.md#一发送者可靠性)
   - [发送者重连](RabbitMQ高级.md#11-发送者重连)
   - [发送者确认](RabbitMQ高级.md#12-发送者确认)
2. [MQ 的可靠性](RabbitMQ高级.md#二mq-的可靠性)
   - [数据持久化](RabbitMQ高级.md#21-数据持久化)
   - [LazyQueue 惰性队列](RabbitMQ高级.md#22-lazyqueue-惰性队列)
3. [消费者的可靠性](RabbitMQ高级.md#三消费者的可靠性)
   - [消费者确认机制](RabbitMQ高级.md#31-消费者确认机制)
   - [失败重试机制](RabbitMQ高级.md#32-失败重试机制)
   - [失败处理策略](RabbitMQ高级.md#33-失败处理策略)
   - [业务幂等性](RabbitMQ高级.md#34-业务幂等性)
   - [兜底方案](RabbitMQ高级.md#35-兜底方案)
4. [延迟消息](RabbitMQ高级.md#四延迟消息)
   - [死信交换机和延迟消息](RabbitMQ高级.md#41-死信交换机和延迟消息)
   - [DelayExchange 插件](RabbitMQ高级.md#42-delayexchange-插件)
5. [面试速记版](RabbitMQ高级.md#五面试速记版)
