...
![长度为65535的varchar报错](https://cdn.xiaobaidebug.top/长度为65535的varchar报错.png)
...
![查看mysql支持哪些charset](https://cdn.xiaobaidebug.top/charset种类.png)

我们尝试下把建表sql语句里的CHARSET改一改，比如改成**utf8mb3**。

我们再执行下，会发现，最大值又不一样了。

![utf8mb3下的报错](https://cdn.xiaobaidebug.top/utf8mb3下的报错.png)
...
![varchar为65533时创建成功](https://cdn.xiaobaidebug.top/varchar为65533时创建成功.png)
...
![是否为NULL的影响](https://cdn.xiaobaidebug.top/是否为NULL的影响.png)
...
![两个varchar列的情况](https://cdn.xiaobaidebug.top/两个varchar列的情况.png)
...
![查看到当前表格使用的行格式](https://cdn.xiaobaidebug.top/查看到当前表格使用的行格式.png)
...
![Dynamic行记录格式](https://cdn.xiaobaidebug.top/Dynamic行记录格式3.drawio.png)
...
![隐藏列有哪些](https://cdn.xiaobaidebug.top/隐藏列有哪些.drawio.png)

所以我们回过头来看我们建的表，当只有一列not null的 varchar字段时，行记录长下面这样。

![单条varchar数据的Dynamic行记录格式.drawio](https://cdn.xiaobaidebug.top/单条varchar数据的Dynamic行记录格式.drawio.png)
...
![页结构](https://cdn.xiaobaidebug.top/页结构.png)
...
![行溢出](https://cdn.xiaobaidebug.top/行溢出.drawio.png)
