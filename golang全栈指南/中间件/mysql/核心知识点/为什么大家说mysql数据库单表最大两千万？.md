...
![user表](https://cdn.xiaobaidebug.top/image/user表数据库原始状态2.drawio.png)
...
![ibd文件内部有大量的页](https://cdn.xiaobaidebug.top/image/ibd文件内部有大量的页.png)
...
![两层B+树结构](https://cdn.xiaobaidebug.top/两层B加树结构.png)
...
![B+树结构](https://cdn.xiaobaidebug.top/B加树结构7.drawio.png)
...
![总行数的计算方法](https://cdn.xiaobaidebug.top/image/总行数的计算方法.png)
...
![B树结构](https://cdn.xiaobaidebug.top/image/B树结构.png)
