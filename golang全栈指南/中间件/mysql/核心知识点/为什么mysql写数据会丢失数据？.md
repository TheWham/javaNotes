...
![建表sql语句](http://cdn.xiaobaidebug.top/image/建表sql语句.png)

接下来如果你插入的数据是

![insert成功case](https://cdn.xiaobaidebug.top/image/insert成功case.png)

**能成功**。一切正常。

但如果你插入的是

![insert失败case](https://cdn.xiaobaidebug.top/image/insert失败case.png)
...
![debug的编码](https://cdn.xiaobaidebug.top/image/debug的编码.drawio.png)
...
![unicode比ascii多使用一个字节](https://cdn.xiaobaidebug.top/image/unicode比ascii多使用一个字节.drawio.png)

我们可以注意到，上面的 unicode 规定的字符码，放在前面的都是 0，其实用不上，但还**占了个字节，有点浪费，完全能隐藏掉**。如果我们能做到该隐藏时隐藏，这样就能省下不少空间，按这个思路，就是就有了**UTF-8 编码**。

![编码格式](https://cdn.xiaobaidebug.top/编码格式2.drawio.png)
...
![字符和字符集的关系](https://cdn.xiaobaidebug.top/image/字符和字符集的关系3.drawio.png)

## mysql 的字符集

想看下 mysql 支持哪些字符集。可以执行 `show charset;`

![数据库支持哪些字符集](https://cdn.xiaobaidebug.top/image/数据库支持哪些字符集.png)
...
![utf8mb3和utf8mb4的关系](https://cdn.xiaobaidebug.top/image/utf8mb3和utf8mb4的关系5.drawio.png)
...
![utf8mb4字符集比较规则](https://cdn.xiaobaidebug.top/image/utf8mb4字符集比较规则-20220421210049625.png)
...
![对比规则-大小写不敏感](https://cdn.xiaobaidebug.top/image/对比规则-大小写不敏感2.png)

如果改成`collation=utf8mb4_bin`，就是指**挨个比较二进制位大小**。

于是**"debug"和"Debug"就不是同一个单词。**

![对比规则-大小写敏感](https://cdn.xiaobaidebug.top/image/对比规则-大小写敏感.png)
...
![查看数据库表的字符集](https://cdn.xiaobaidebug.top/image/查看数据库表的字符集2.png)
...
![](https://cdn.xiaobaidebug.top/image-20220522162616202.png)![](https://cdn.xiaobaidebug.top/image/006APoFYly1g5q9gn2jipg308w08wqdi.gif)
