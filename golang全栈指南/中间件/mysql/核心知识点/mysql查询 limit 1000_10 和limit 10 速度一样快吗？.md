...
![](https://cdn.xiaobaidebug.top/image-20220603221954745.png)
我们很容易能联想到可以用 mysql 实现。

假设我们的建表 sql 是这样的

![mysql建表sql](https://cdn.xiaobaidebug.top/image/mysql建表sql5.png)
...
![user表数据库原始状态](https://cdn.xiaobaidebug.top/image/user表数据库原始状态6.drawio.png)
...
![Mysql架构](https://cdn.xiaobaidebug.top/image/Mysql架构6.drawio.png)
...
![分页查询offset=0](https://cdn.xiaobaidebug.top/image/分页查询offset=0.png)

主键索引本质是一棵 B+树，它是放在 innodb 中的一个数据结构。

我们可以回忆下，B+树大概长这样。

![B+树结构](https://cdn.xiaobaidebug.top/B加树结构2d.png)
...
![回表](https://cdn.xiaobaidebug.top/image/回表.drawio.png)
...
![非主键索引offset值超大时走全表扫描](https://cdn.xiaobaidebug.top/image/非主键索引offset值超大时走全表扫描.png)
...
![batch获取数据](https://cdn.xiaobaidebug.top/image/batch获取数据.png)
...
![上下页的形式](https://cdn.xiaobaidebug.top/image/上下页的形式.drawio.png)
...
《MySQL 的 Limit 子句底层原理你不可不知》[https://blog.csdn.net/qq_34115899/article/details/120727513](https://blog.csdn.net/qq_34115899/article/details/120727513)
