...
![undo日志会记录之前的数据](https://cdn.xiaobaidebug.top/image/undo日志会记录之前的数据.drawio.png)
...
![undo日志版本链](https://cdn.xiaobaidebug.top/image/undo日志版本链.png)
...
![当前读和快照读](https://cdn.xiaobaidebug.top/image/当前读和快照读.drawio.png)
...
![readview与undo版本链](https://cdn.xiaobaidebug.top/image/readview与undo版本链3.drawio.png)
...
![user表数据库原始trx信息.drawio](https://cdn.xiaobaidebug.top/image/user表数据库原始trx信息.drawio.png)
...
![事务1的readview](https://cdn.xiaobaidebug.top/image/事务1的readview.drawio.png)
...
![user表数据库加入undo日志](https://cdn.xiaobaidebug.top/image/user表数据库加入undo日志.drawio.png)
