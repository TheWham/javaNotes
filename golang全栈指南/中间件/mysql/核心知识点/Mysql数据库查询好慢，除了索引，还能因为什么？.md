...
![Mysql架构](https://cdn.xiaobaidebug.top/Mysql架构56.drawio.png)
...
![bufferPool与磁盘](https://cdn.xiaobaidebug.top/image/bufferPool与磁盘2.png)
...
![索引页与磁盘页的关系](https://cdn.xiaobaidebug.top/image/索引页与磁盘页的关系.png)
...
![索引前缀区分度太低](https://cdn.xiaobaidebug.top/image/索引前缀区分度太低.drawio.png)
...
![连接过少会导致sql阻塞](https://cdn.xiaobaidebug.top/image/连接过少会导致sql阻塞.png)
...
![增加连接可以加快执行sql](https://cdn.xiaobaidebug.top/image/增加连接可以加快执行sql.png)
...
![查询缓存被删除](https://cdn.xiaobaidebug.top/image/查询缓存被删除.png)
