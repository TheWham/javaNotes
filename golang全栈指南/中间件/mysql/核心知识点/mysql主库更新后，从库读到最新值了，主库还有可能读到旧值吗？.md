...
![mysql读写分离](https://cdn.xiaobaidebug.top/image/mysql读写分离2.drawio-20220419205818771.png)
...
![数据库原始状态](https://cdn.xiaobaidebug.top/image/数据库原始状态.png)
...
![mysql主从同步](https://cdn.xiaobaidebug.top/image/mysql主从同步-20220419210000882.png)
...
![一个case解释隔离级别](https://cdn.xiaobaidebug.top/image/一个case解释隔离级别.2drawio.png)
...
![数据库原始状态](https://cdn.xiaobaidebug.top/image/数据库原始状态-20220419205854846.png)
...
![从库读到最新值主库却读到旧值](https://cdn.xiaobaidebug.top/image/2从库读到最新值主库却读到旧值.drawio.png)
