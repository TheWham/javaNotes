...
![TCP是什么](https://cdn.xiaobaidebug.top/image/tcp是什么2.png)
...
![TCP四次挥手](https://cdn.xiaobaidebug.top/image/TCP四次挥手7.png)
...
![FIN-WAIT-2特别多的原因](https://cdn.xiaobaidebug.top/image/FIN-WAIT-2特别多的原因.png)
...
![close()触发TCP四次挥手](<https://cdn.xiaobaidebug.top/image/close()触发TCP四次挥手5.png>)
...
![shutdown触发的TCP四次挥手](https://cdn.xiaobaidebug.top/image/shutdown触发的TCP四次挥手.png)
...
![tcp_sendmsg逻辑](https://cdn.xiaobaidebug.top/image/tcp_sendmsg逻辑2.png)
...
![一直不发第三次挥手的情况](https://cdn.xiaobaidebug.top/image/一直不发第三次挥手的情况3.png)
...
![TCP三次挥手](https://cdn.xiaobaidebug.top/image/TCP三次挥手.png)
...
![TCP三次挥手延迟确认](https://cdn.xiaobaidebug.top/image/TCP三次挥手延迟确认.png)
...
![TCP两次挥手](https://cdn.xiaobaidebug.top/image/TCP两次挥手2.png)
...
![TCP自连接](https://cdn.xiaobaidebug.top/image/TCP自连接2.png)
...
![TCP同时打开](https://cdn.xiaobaidebug.top/image/TCP同时打开2.png)
...
![](https://cdn.xiaobaidebug.top/image-20220522162616202.png)## 文章推荐：
...
- [硬核！漫画图解 HTTP 知识点+面试题](硬核！漫画图解HTTP知识点_面试题.md)
