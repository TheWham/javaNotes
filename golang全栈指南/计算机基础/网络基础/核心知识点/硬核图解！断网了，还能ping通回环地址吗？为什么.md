...
![回环地址](https://cdn.xiaobaidebug.top/image/回环地址.png)
...
![ipv6回环地址](https://cdn.xiaobaidebug.top/image/ipv6回环地址.png)
...
![IP和ICMP和Ping所在分层](https://cdn.xiaobaidebug.top/image/IP和ICMP和Ping所在分层.png)

虽然 ICMP 协议和 IP 协议**都属于网络层协议**，但其实**ICMP 也是利用了 IP 协议进行消息的传输**。

![ip和icmp的关系](https://cdn.xiaobaidebug.top/image/ip和icmp的关系.png)
...
![ping和普通发消息的关系](https://cdn.xiaobaidebug.top/image/ping和普通发消息的关系2.png)
...
![ping回环地址](https://cdn.xiaobaidebug.top/image/ping回环地址.png)
...
![工具人ksoftirqd](https://cdn.xiaobaidebug.top/image/工具人ksoftirqd.png)
