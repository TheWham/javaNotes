![握手建立连接流程](https://cdn.xiaobaidebug.top/image/握手建立连接流程3.gif)
...
![每个listen Socket都有一个全连接和半连接队列](https://cdn.xiaobaidebug.top/image/每个listenSocket.png)

### 半连接队列、全连接队列是什么

![半连接队列和全连接队列](https://cdn.xiaobaidebug.top/image/半连接队列和全连接队列3.png)
...
![半连接全连接队列的内部结构](https://cdn.xiaobaidebug.top/image/半连接全连接队列的内部结构.png)
...
![tcp_abort_on_overflow为0](https://cdn.xiaobaidebug.top/image/tcp_abort_on_overflow为0.png)
...
![tcp_abort_on_overflow为1](https://cdn.xiaobaidebug.top/image/tcp_abort_on_overflow为1.png)
...
![syn攻击](https://cdn.xiaobaidebug.top/image/syn攻击.png)
...
![tcp_syncookies=1](https://cdn.xiaobaidebug.top/image/开启tcp_syncookies.drawio.png)
...
![tcp报头_seq的位置](https://cdn.xiaobaidebug.top/image/tcp报头_seq的位置.png)
...
![ack攻击](https://cdn.xiaobaidebug.top/image/ack攻击2.gif)
