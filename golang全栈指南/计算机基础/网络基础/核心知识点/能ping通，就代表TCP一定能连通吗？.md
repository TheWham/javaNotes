...
![ping正常](https://cdn.xiaobaidebug.top/ping正常.png)

![ping不通](https://cdn.xiaobaidebug.top/ping不通.png)
...
![ping和TCP发消息的区别](https://cdn.xiaobaidebug.top/ping和普通发消息的关系67.drawio.png)

我们知道网络是分层的，每一层都有对应协议。

![五层网络协议对应的消息体变化分析](https://cdn.xiaobaidebug.top/五层网络协议对应的消息体变化分析.png)
...
![路由器构成的网络](https://cdn.xiaobaidebug.top/路由器构成的网络.drawio.png)
...
![路由器和Dijkstra](https://cdn.xiaobaidebug.top/路由器的Dijkstra.drawio.png)
...
![通过路由表转发数据](https://cdn.xiaobaidebug.top/路由互联时新版.drawio.png)
...
![没有ECMP时只能选择某一条路径](https://cdn.xiaobaidebug.top/没有ECMP时只能选择某一条路径.drawio4.png)
...
![利用ECMP可以同时使用两条链路](https://cdn.xiaobaidebug.top/利用ECMP可以同时使用两条链路.drawi3o.png)
...
![乱序队列等待数据包的到来](https://cdn.xiaobaidebug.top/乱序队列等待数据包的到来.drawio.png)
...
![五元组](https://cdn.xiaobaidebug.top/五元组.drawio.png)

然后对五元组信息生成哈希键，让同一个哈希键的数据走同一条路径，问题就完美解决了。

![五元组映射成hash键](https://cdn.xiaobaidebug.top/五元组映射成hash键.drawio.png)

![根据五元组选择ECMP路径](https://cdn.xiaobaidebug.top/根据五元组选择ECMP路径.3.png)
...
![TCP和ping的五元组差异](https://cdn.xiaobaidebug.top/TCP和ping的五元组差异.drawio.png)
...
![不同TCP连接的五元组差异](https://cdn.xiaobaidebug.top/不同TCP连接的五元组差异.drawio.png)
...
![ping能成功但部分TCP连接失败](https://cdn.xiaobaidebug.top/ping能成功但部分TCP连接失败.drawio.png)
...
![](https://cdn.xiaobaidebug.top/image-20220522162616202.png)![](https://cdn.xiaobaidebug.top/006APoFYly1g5q9gn2jipg308w08wqdi-20220806162638482.gif)
